...
export default class Pokemon extends Component {
  ...
  async componentDidMount() {
    ...
    // Convert Decimeters to meters... The + 0.0001 * 100 ) / 100 is for rounding to two decimal places :)
    const height =
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="row">
                  ...
                  <div className="col-6">
                    <h6 className="float-right">Tasa de captura:</h6>
                  </div>
                  <div className="col-6">
                    <h6 className="float-left">{this.state.catchRate}%</h6>
                  </div>
                  <div className="col-6">
                    <h6 className="float-right">Proporción de género:</h6>
                  </div>
                  <div className="col-6">
                    <div className="progress">
                      <div
